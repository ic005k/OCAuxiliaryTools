...
- 如果Auto，在KeySupport为true时视为Enabled，否则视为Disabled。

- 如果Enabled，则使用KeyInitialDelay和KeySubsequentDelay的值。

- 如果Disabled，则使用Apple默认值500ms (50)和50ms (5)。</source>
        <translation></translation>
    </message>
    <message>
...
可以通过将UIScale设置为02的无效光标大小来诊断，在APTIO V之前的一般平台（Haswell和更早版本）中会受到影响。</translation>
    ...
    <message>
        <location filename="mainwindow.ui" line="9187"/>
