...
<context>
    ...
    <message>
        <location filename="autoupdatedialog.ui" line="27"/>
        <source>The upgrade will start automatically after closing, 
 please turn it on again later.</source>
        <translation>升级将在关闭之后自动进行，稍后请打开它。</translation>
    </message>
    <message>
        <location filename="autoupdatedialog.ui" line="35"/>
...
Note2 : It is strongly recommended not to make a habit of running macOS with SIP disabled. Use of this boot option may make it easier to quickly disable SIP protection when genuinely needed - it should be re-enabled again afterwards.

----

类型：plist布尔值

描述：用于在OpenCore选取器中禁用和启用系统完整性保护。

这将使苹果NVRAM变量csr-active-config在SIP Enabled的0和SIP Disabled的当前macOS默认值（Big Sur目前为0x6F）之间切换。

注意1：在旧版本的macOS（例如Catalina和以下的版本）上使用较新版本的SIP Disabled值，如果使用csrutil status查询，将报告一个未知的设置，但仍将正确运行，并且是安全的，因为新的位被添加，但旧的位在macOS版本之间没有被删除。(可以将CsrUtil.efi配置为TextMode Tools条目，以配置不同的值，例如，使用Arguments中的toggle 0x67来切换macOS Catalina的默认SIP Disabled值。)

注意2：强烈建议不要养成在禁用SIP的情况下运行macOS的习惯。使用这个启动选项可以在真正需要的时候更容易快速地禁用SIP保护，之后应该再重新启用。</source>
        <translation></translation>
    </message>
    <message>
...
可能为空，也可能为Type2-Board资产标签。</translation>
    ...
    <message>
        <location filename="mainwindow.ui" line="10162"/>
...
BaseSkip</translation>
    ...
    <message>
        ...
        <source>The following files will be overwritten: </source>
        <translation>下面的文件将被覆盖：</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="commands.cpp" line="135"/>
        <source>Edit</source>
        <translation>编辑</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="syncocdialog.cpp" line="33"/>
        <source>Successfully synced to OpenCore: </source>
        <translation>成功同步到OpenCore：</translation>
    </message>
    <message>
        <location filename="syncocdialog.cpp" line="49"/>
        <source>Source file last modified</source>
        <translation>源文件最后修改</translation>
    </message>
    <message>
        <location filename="syncocdialog.cpp" line="51"/>
