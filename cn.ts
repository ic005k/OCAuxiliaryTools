...
trim.</source>
        <translation>根据SSD控制器的不同，修剪过程可能需要相当长的时间，导致启动速度明显变慢，因为这时APFS驱动程序会执行修剪操作。如果固态硬盘支持超额配置，或者有专门的未使用分区可以用来保留区块，则可能不需要进行修剪操作。另一方面，如果SSD的速度很慢，默认的超时时间（相当于9.999999秒）可能会不够用。详情请看本文。
...
is able to play boot chime.</source>
        <translation>启用此设置可通过内置音频支持播放启动铃声。 音量级别由MinimumVolume和VolumeAmplifier设置以及SystemAudioVolume NVRAM变量确定。 可能的值包括：
...
alctsel property instead.</source>
        <translation>AppleHDA kext只有在TCSEL寄存器被配置为使用TC0通道类的情况下才能正常工作。请参阅Intel I/O控制器集线器9（ICH9）系列数据表（或任何其他ICH数据表），了解该寄存器的更多细节。
...
<context>
    ...
    <message>
        <location filename="commands.cpp" line="124"/>
        <source>Edit</source>
        <translation>编辑</translation>
    </message>
    <message>
        <location filename="commands.cpp" line="186"/>
        <source>Paste Line</source>
        <translation>粘贴行</translation>
    </message>
</context>
